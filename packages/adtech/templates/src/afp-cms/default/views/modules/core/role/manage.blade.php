...
@section('title'){{ $title = trans('afp-core::titles.role.manage') }}@stop
            ...
            <md-table-container style="margin: 20px 0px">
                <table md-table multiple>
                    ...
                    <tr md-row>
                        ...
                        <th md-column md-text><span>{{ $labelName = trans('afp-core::common.role.name') }}</span></th>
    ...
    <md-dialog flex="60">
        <md-toolbar>
            <div class="md-toolbar-tools">
                <h2>{{ trans('afp-core::titles.role.add') }}</h2>
                <span flex></span>
...
<script type="text/ng-template" id="frm-edit-role">
    <md-dialog flex="60">
        <md-toolbar>
            <div class="md-toolbar-tools">
                <h2>{{ trans('afp-core::titles.role.edit') }}</h2>
                <span flex></span>
                <md-button class="md-icon-button" ng-click="closeDialog()">
                    <i class="material-icons">close</i>
                </md-button>
    ...
    angular.module("AdtechApp")
        .run(function ($rootScope) {
            $rootScope.getRoles = function () {
                ...
                var url = '{{ route('adtech.core.role.list') }}',
